// Original from https://github.com/marivaaldo/evil-portal-m5stack/

#define DEFAULT_AP_SSID_NAME "Orca Portal"
#define SD_CREDS_PATH "/orca-one-creds.txt"
